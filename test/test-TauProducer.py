...
import os
process = cms.Process("TauProducer")
...
process.out = cms.OutputModule( "PoolOutputModule",
                                fileName = cms.untracked.string("Level1Taus.root"),
...
process.schedule = cms.Schedule(process.L1Clusters,process.TTTracksWithTruth,process.L1PFObjects,process.L1PFTaus,process.FEVToutput_step)
